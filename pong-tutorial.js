...
var wasmSourceMapFile = "pong-tutorial.wasm.map";
...
function findWasmBinary() {
  return locateFile("pong-tutorial.wasm");
}
...
var ASM_CONSTS = {
  ...
  109299: () => Module.canvas.width,
  109331: () => parseInt(Module.canvas.style.width),
  109379: () => {
  ...
  109742: () => window.innerWidth,
  109768: () => window.innerHeight,
  109795: () => {
    if (document.fullscreenElement) return 1;
  },
  109841: () => Module.canvas.width,
  109873: () => parseInt(Module.canvas.style.width),
  109921: () => {
    if (document.fullscreenElement) return 1;
  },
  109967: () => Module.canvas.width,
  109999: () => screen.width,
  110024: () => window.innerWidth,
  110050: () => window.innerHeight,
  110077: () => {
    if (document.fullscreenElement) return 1;
  },
  110123: () => Module.canvas.width,
  110155: () => screen.width,
  110180: () => {
    document.exitFullscreen();
  },
  ...
  110253: () => Module.canvas.width,
  110285: () => parseInt(Module.canvas.style.width),
  110333: () => {
    document.exitFullscreen();
  },
  110360: $0 => {
  ...
  110398: () => screen.width,
  110423: () => screen.height,
  110449: () => window.screenX,
  110476: () => window.screenY,
  110503: () => window.devicePixelRatio,
  110539: $0 => {
  ...
  111080: () => window.innerWidth,
  111106: () => window.innerHeight
};
...
var ___emscripten_embedded_file_data = Module["___emscripten_embedded_file_data"] = 65564;
